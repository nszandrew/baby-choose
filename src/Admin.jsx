        ...
        <div className="h-screen w-screen font-sans bg-gradient-to-br from-blue-100 to-pink-100 flex items-center justify-center p-4">
            {!logged ? (
                <div className="bg-white rounded-xl shadow-xl p-8 max-w-sm w-full flex flex-col items-center">
                    <h2 className="text-2xl font-bold mb-4 text-blue-600">Painel de Admin</h2>
                    <input
                        type="password"
                ...
                <div className="bg-white rounded-xl shadow-xl p-8 w-full max-w-3xl">
                    <h2 className="text-3xl font-bold text-center text-pink-600 mb-6">Resumo da Votação</h2>
                    ...
                    <div className="flex justify-center gap-4 mb-6">
                        <button
                            ...
                            className={`px-4 py-2 rounded-full font-bold text-white shadow-md transition ${chosen === 'male'
                                    ? 'bg-blue-700'
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-full font-bold text-white shadow-md transition ${chosen === 'female'
                                    ? 'bg-pink-700'
                    ...
                    <button
                        ...
                        disabled={!chosen}
                        className={`block mx-auto mt-2 px-6 py-3 rounded-full shadow-lg text-white transition ${chosen
                    ...
                    {reveal && chosen && (
                        <div className="mt-6 text-center text-2xl font-bold text-green-600">
                            🎉 Resultado liberado: É {chosen === 'male' ? 'MENINO 💙' : 'MENINA 💖'}!
                        </div>
                    )}
                </div>
            )}
